...
**Client:** `CC#0#{char_id}#{hdid}#%`<br></br>
...
**Client:** `MC#{songname}#{char_id}#{showname}#{effects}#%`<br></br>
...
**Client:** `CASEA#{case_title}#{need_def}#{need_pro}#{need_judge}#{need_jury}#{need_steno}#%`<br></br>
...
**Client:** `ZZ#{reason}#%`<br></br>
**Server:** `ZZ#{message}#%`<br></br>
...
**Client:** `askforservers#%` (returns first server on the list starting from 0)<br></br>
**Server:** first server<br></br>
**Client:** `SR#{n}#%`<br></br>
